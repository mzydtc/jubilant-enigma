	...
	<form action="__APP__/User/addUserProcess" method="post" role="form">
        ...
        <div class="form-group">
  			<select class="form-control" id="department"> 
        		<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$dep): $mod = ($i % 2 );++$i;?><option><?php echo ($dep["depname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
  			</select>
	    </div>
