...
CREATE TABLE IF NOT EXISTS `mail_list_by_温德盛` (
  ...
  `read` int(4) NOT NULL COMMENT '已读/未读(0/1)',
  PRIMARY KEY (`id`)
...
INSERT INTO `mail_list_by_温德盛` (`id`, `revfrom`, `sendto`, `title`, `content`, `time`, `stat`, `attach`, `filename`, `read`) VALUES
(10, NULL, '郑经伟', '郑经伟', '沙发上大概', '2016-03-08 21:59:32', 1, 0, '', 0),
(14, NULL, '温德盛', '无附件', '', '2016-03-09 22:00:42', 1, 0, '', 0),
(16, NULL, '温德盛', '有附件', '', '2016-03-09 22:02:16', 1, 1, 'jia_k.pdf', 0),
(18, NULL, '郑经伟', '郑经伟是个哈斯儿', '郑茎萎', '2016-03-09 22:26:24', 1, 1, 'php_manual_zh_review.chm', 0),
(19, NULL, '郑经伟', '中文附件', '', '2016-03-09 22:35:23', 1, 1, '位运算.txt', 0),
(20, NULL, '郑经伟', '郑茎萎是个哈斯儿', '', '2016-03-09 22:38:48', 1, 1, '战争与革命中的西南联大台版.pdf', 0),
(45, NULL, '温德盛', '试试就试试', '', '2016-03-11 14:40:08', 1, 1, '位运算.txt', 0),
(57, NULL, '温德盛', '啊刚刚打啥水果的撒公司大啊广东省的哈哈等哈啊广东省的哈哈等哈啊广东省的哈哈等哈啊广东省的哈哈等哈', '', '2016-03-13 16:02:44', 1, 0, '', 0),
(58, '温德盛', NULL, '啊刚刚打啥水果的撒公司大啊广东省的哈哈等哈啊广东省的哈哈等哈啊广东省的哈哈等哈啊广东省的哈哈等哈', '', '2016-03-13 16:02:44', 0, 0, '', 0),
(85, NULL, '温德盛', '单发', '单发', '2016-03-14 17:38:28', 1, 0, '', 0),
(86, '温德盛', NULL, '单发', '单发', '2016-03-14 17:38:28', 0, 0, '', 0),
(87, NULL, '郑经伟', '单发（带附件）', '', '2016-03-14 17:39:40', 1, 1, '7887e2a7jw1e7nds3d6cog20b4069kj2.gif', 0),
(89, '温德盛', NULL, '群发', '群发', '2016-03-14 17:40:18', 2, 0, '', 0),
(90, '郑经伟', NULL, '群发（带附件）', '群发', '2016-03-14 17:42:38', 2, 1, '2012碉堡视频集锦.flv', 0),
(91, NULL, '温德盛;郑经伟;林左鸣;沈盼盼;', 'ajax', 'jquery ajax', '2016-03-15 17:11:19', 1, 1, '数据库安装及使用.pdf', 0),
(92, '温德盛', NULL, 'ajax', 'jquery ajax', '2016-03-15 17:11:19', 2, 1, '数据库安装及使用.pdf', 0),
(93, NULL, '温德盛', '转发测试', '转发测试', '2016-03-17 00:11:39', 1, 1, 'CAPP工艺从定义到PDM系统集成.docx', 0),
(99, NULL, '郑经伟;田志远;温德盛;', '转发（带附件）', '          \r\n转发（带附件）\r\n\r\n          \r\n\r\n          \r\n\r\n          \r\n\r\n          原始发件人：温德盛\r\n\r\n          发送时间：2016-03-17 18:09:37\r\n\r\n          标题：test\r\n\r\n          正文：          ', '2016-03-17 22:15:13', 1, 1, 'mysql.chm', 0),
(101, NULL, '温德盛', 'test', '          \n\n          \n\n          \n\n          \n\n          原始发件人：温德盛\n\n          发送时间：2016-03-17 18:09:37\n\n          标题：test\n\n          正文：          ', '2016-03-17 22:23:27', 1, 0, '', 0),
(117, NULL, '田志远;郑经伟;', 'aaa', '          \r\n\r\n          \r\n\r\n          \r\n\r\n          \r\n\r\n          原始发件人：\r\n\r\n          发送时间：2016-03-18 00:02:11\r\n\r\n          标题：testtesttesttesttest\r\n\r\n          正文：          \r\n\r\n          \r\n\r\n          \r\n\r\n          \r\n\r\n          原始发件人：\r\n\r\n          发送时间：2016-03-18 00:00:58\r\n\r\n          标题：testtesttesttest\r\n\r\n          正文：          \r\n\r\n          \r\n\r\n          \r\n\r\n          \r\n\r\n          原始发件人：\r\n\r\n          发送时间：2016-03-17 23:55:17\r\n\r\n          标题：testtesttest\r\n\r\n          正文：testtesttest                              ', '2016-03-18 00:07:26', 1, 1, 'JDK_API_1_6_zh_CN.CHM', 0),
(118, NULL, '沈盼盼;马赞军;', 'bbb', '          \r\n\r\n          \r\n\r\n          \r\n\r\n          \r\n\r\n          原始发件人：温德盛\r\n\r\n          发送时间：2016-03-18 00:00:58\r\n\r\n          标题：testtesttesttest\r\n\r\n          正文：          \r\n\r\n          \r\n\r\n          \r\n\r\n          \r\n\r\n          原始发件人：\r\n\r\n          发送时间：2016-03-17 23:55:17\r\n\r\n          标题：testtesttest\r\n\r\n          正文：testtesttest                    ', '2016-03-18 00:08:11', 1, 1, 'JDK_API_1_6_zh_CN.CHM', 0),
(119, NULL, '田志远', '1', '', '2016-03-18 08:34:35', 1, 1, '位运算.txt', 0),
(120, '田志远', NULL, '2', '2222', '2016-03-18 08:36:58', 0, 1, '配置php.ini上传文件大小.txt', 0),
(121, NULL, '郑经伟', '3', '          \r\n\r\n          \r\n\r\n          \r\n\r\n          \r\n\r\n          原始发件人：田志远\r\n\r\n          发送时间：2016-03-18 08:36:58\r\n\r\n          标题：2\r\n\r\n          正文：2222          ', '2016-03-18 08:37:50', 1, 1, '配置php.ini上传文件大小.txt', 0),
(122, '马赞军', NULL, '5', '          \r\n\r\n          \r\n\r\n          \r\n\r\n          \r\n\r\n          原始发件人：郑经伟\r\n\r\n          发送时间：2016-03-18 08:39:10\r\n\r\n          标题：4\r\n\r\n          正文：          444444444\r\n\r\n          \r\n\r\n          \r\n\r\n          \r\n\r\n          原始发件人：温德盛\r\n\r\n          发送时间：2016-03-18 08:37:50\r\n\r\n          标题：3\r\n\r\n          正文：          \r\n\r\n          \r\n\r\n          \r\n\r\n          \r\n\r\n          原始发件人：田志远\r\n\r\n          发送时间：2016-03-18 08:36:58\r\n\r\n          标题：2\r\n\r\n          正文：2222                              ', '2016-03-18 08:40:38', 0, 0, '', 0),
(124, NULL, '温德盛', '回复测试', '回复回复', '2016-03-18 09:55:50', 1, 1, '2015.11.01.docx', 0),
(125, '温德盛', NULL, '回复测试', '回复回复', '2016-03-18 09:55:50', 0, 1, '2015.11.01.docx', 0),
(126, NULL, '温德盛;田志远;', '哈哈哈哈', '', '2016-03-20 01:20:48', 1, 0, '', 0),
(127, '温德盛', NULL, '哈哈哈哈', '', '2016-03-20 01:20:48', 0, 0, '', 0),
(128, NULL, '温德盛', 'read', 'read', '2016-03-20 17:09:32', 1, 0, '', 1),
(129, '温德盛', NULL, 'read', 'read', '2016-03-20 17:09:32', 0, 0, '', 1);
